...
-- Goal: Allow leads to Manage Tasks Even if Team is Incomplete
-- ============================================
...
-- 3. INSERT: leads can always create tasks. 
...
-- 4. UPDATE: 
-- - lead can update any task at any time
...
-- 5. DELETE: Only project lead can delete tasks
...
DO $$
BEGIN
  RAISE NOTICE '✅ Task RLS Policies Updated to allow lead management regardless of team completion.';
END $$;
