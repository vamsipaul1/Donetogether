...
BEGIN
    ...
    (v_project_id, 'Setup AI Infrastructure', v_lead_id, v_lead_id, 'in_progress', CURRENT_DATE - INTERVAL '1 day'), 
    (v_project_id, 'Design System UI', v_anil_id, v_lead_id, 'in_progress', CURRENT_DATE + INTERVAL '2 days'),
    (v_project_id, 'API Integration', v_dhanunjaya_id, v_lead_id, 'in_progress', CURRENT_DATE + INTERVAL '3 days');
