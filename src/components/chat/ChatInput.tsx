...
export const ChatInput = ({ onSendMessage, isLoading, projectId, replyTo, setReplyTo }: ChatInputProps) => {
    ...
    return (
        <div className="relative px-6 pb-6 pt-2 z-40">
            <div className="max-w-5xl mx-auto relative">
                ...
                {replyTo && (
                    <motion.div
                        ...
                        className="mb-2 px-1"
                    >
                        <div className="flex items-center gap-3 px-4 py-2 bg-emerald-50 dark:bg-emerald-500/10 border-l-4 border-emerald-500 rounded-r-xl shadow-sm">
                            ...
                            <button onClick={() => setReplyTo(null)} className="p-1 hover:bg-emerald-500/20 rounded-md transition-colors">
                ...
                <div className={cn(
                    ...
                    isFocused
                        ? "bg-white dark:bg-zinc-900 ring-2 ring-emerald-500/20"
                    ...
                    <div className="pb-0.5">
                        <Popover>
                            <PopoverTrigger asChild>
                                <button className="h-9 w-9 rounded-full flex items-center justify-center text-zinc-400 hover:text-emerald-500 hover:bg-emerald-50 dark:hover:bg-emerald-500/10 transition-all">
