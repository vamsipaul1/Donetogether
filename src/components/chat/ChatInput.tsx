            ...
            <div className="max-w-5xl mx-auto relative">
                ...
                {replyTo && (
                    <motion.div
                        ...
                        className="mb-2 px-1"
                    >
                        <div className="flex items-center gap-3 px-4 py-2 bg-zinc-50 dark:bg-zinc-800 border-l-4 border-purple-600 dark:border-purple-500 rounded-r-xl shadow-sm">
                ...
                <div className={cn(
                    ...
                    <div className="flex-1 flex flex-col gap-1.5 py-1.5">
                        {uploadedFile && (
                            <div className="flex items-center gap-2 p-2 bg-purple-50/50 dark:bg-zinc-800/50 rounded-xl border border-purple-100/50 dark:border-zinc-700/50 w-fit">
                        ...
                        <button
                            ...
                            className={cn(
                                ...
                                (message.trim() || uploadedFile)
                                    ? "bg-purple-600 text-white shadow-md hover:scale-110 active:scale-95 dark:bg-purple-600 dark:text-white"
