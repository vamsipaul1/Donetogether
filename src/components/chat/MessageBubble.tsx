...
export const MessageBubble = ({
    ...
    // Debug: Log isOwnMessage to see if it's being set correctly
    useEffect(() => {
        console.log('MessageBubble:', {
            ...
            currentUserId,
            isOwnMessage,
            comparison: message.sender_id === currentUserId
        });
    }, [message.id, isOwnMessage, currentUserId]);
        ...
        >
            ...
            {!isOwnMessage && (
                <div className="w-9 flex flex-col justify-end mr-3">
                    {!isSequence ? (
                        <Avatar className="h-9 w-9 shadow-md ring-1 ring-zinc-100 dark:ring-zinc-800">
                ...
                <ContextMenu>
                    <ContextMenuTrigger>
                        <motion.div
                            ...
                            className={cn(
                                "relative px-4 py-2.5 rounded-[20px] text-[15px] leading-relaxed transition-all shadow-sm flex flex-col gap-2",
                                isOwnMessage
                                    ? "bg-emerald-800 dark:bg-emerald-900 text-white rounded-tr-none shadow-emerald-900/10"
                                    : "bg-white dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800 text-zinc-900 dark:text-zinc-100 rounded-tl-none shadow-zinc-100/50 dark:shadow-none"
                            )}
                        >
                            ...
                            return (
                                <motion.button
                                    ...
                                    className={cn(
                                        ...
                                        userReacted
                                            ? "bg-emerald-50 border-emerald-500/30 text-emerald-700 dark:bg-emerald-900/30 dark:border-emerald-500/50 dark:text-emerald-400"
